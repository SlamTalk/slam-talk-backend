...
public class RegisterMatePostController {
    ...
    @Operation( // Swagger 쓰는 이유!
            summary = "메이트 찾기 글 등록", // 기능 제목 입니다
            description = "메이트 찾기 글쓰기 버튼을 누르고 글을 쓰는 폼을 작성하여 제출할때 접근하는 api 입니다. POST 요청 시 JSON 형식은 다음의 API 명세서를 참고해주세요. https://www.notion.so/6407bc994ee04e009bf22513119eb18a", // 기능 설명
            tags = {"유저"} // 유저인지 관리자기능인지 여부
    )
    ...
    public ApiResponse registerMatePost(@RequestBody MateFormDTO mateFormDTO){
        ...
        MatePost matePost = mateFormDTO.toEntity(userId, userNickname, userLocation);
