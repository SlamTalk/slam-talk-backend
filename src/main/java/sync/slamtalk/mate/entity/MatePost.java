...
public class MatePost extends BaseEntity implements Post {
    ...
    public void updateSchedule(LocalDate date, LocalTime start, LocalTime end) {
        if (date == null || start == null || end == null) {
           throw new AssertionError("일정 변경 정보가 올바르지 않습니다.");
        }
        this.schedule.update(date, start, end);
    }
